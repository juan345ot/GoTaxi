 ...
 */
// true si usás el emulador de Android, false para teléfono físico
...
export default {
  ...
  API_URL: `${ORIGIN}/api`,
  // ✅ Socket apuntando al mismo host/puerto
  // (si tu server usa socket.io por defecto no hace falta path)
